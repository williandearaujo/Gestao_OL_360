      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500 hover:shadow-lg transition-shadow">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-ol-gray-600">Certificações OK</p>
                <p className="text-3xl font-bold text-green-600">24</p>
                <p className="text-xs text-green-500 mt-1">Em dia</p>
              </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg border border-green-200">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-green-700 font-medium">Backend API Online</span>
              </div>
              <span className="text-green-600 text-sm bg-green-100 px-2 py-1 rounded">Conectado</span>
            </div>
            ...
            <div className="flex items-center justify-between p-4 bg-ol-brand-50 rounded-lg border border-ol-brand-200">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-ol-brand-700 font-medium">Frontend React Funcionando</span>
              </div>
              <span className="text-ol-brand-600 text-sm bg-ol-brand-100 px-2 py-1 rounded">Ativo</span>
            </div>
          </div>
        </div>
        ...
        <div className="mt-8 text-center bg-ol-brand-50 rounded-lg p-6 border border-ol-brand-200">
          <div className="inline-flex items-center space-x-2 mb-2">
            ...
            <h3 className="text-xl font-semibold text-ol-brand-500">Sistema Funcionando!</h3>
          </div>
          <p className="text-ol-gray-600 mb-1">Parabéns! Seu sistema Gestão OL 360 está operacional.</p>
          <p className="text-sm text-ol-brand-400 mt-2">Baseado na identidade visual da OL Tecnologia</p>
        </div>
      </main>
    </div>
  );
